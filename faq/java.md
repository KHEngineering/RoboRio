...
To find the RIOLog window, in eclipse, go to Window, Show View, Other… and search for RIOlog and you’ll see it. Once 
you add it, it will stay around between eclipse restarts.
